    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <section className="relative overflow-hidden rounded-3xl glass-card p-8 lg:p-12">
        ...
        <div className="relative z-10">
          ...
          <p className="text-slate-500 max-w-2xl text-base lg:text-lg leading-relaxed">
      ...
      <section className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {stats.map((stat) => {
          ...
          return (
            ...
            >
              <div className={`w-10 h-10 rounded-xl bg-slate-100 flex items-center justify-center ${stat.color}`}>
      ...
      {/* Quick Actions */}
      <section>
        <h2 className="text-lg font-semibold text-slate-500 mb-4">Quick Actions</h2>
